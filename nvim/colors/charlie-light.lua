...
--NEOTREE
vim.api.nvim_set_hl(0, "NeoTreeGitUntracked", { fg = palette.color10, italic = true })
vim.api.nvim_set_hl(0, "Directory", { fg = palette.color10 })
vim.api.nvim_set_hl(0, "Changed", { fg = palette.color10, italic = true })
...
vim.api.nvim_set_hl(0, "Delimiter", { fg = palette.color2 })
vim.api.nvim_set_hl(0, "Operator", { fg = palette.color2 })
...
vim.api.nvim_set_hl(0, "Variable", { bold = true, fg = palette.blue })
