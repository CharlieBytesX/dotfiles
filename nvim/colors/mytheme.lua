...
local highlights = {
  ...
  -- LSP
  DiagnosticUnderlineError = { underline = true, sp = grey },
  DiagnosticUnderlineWarn = { underline = true, sp = grey },
  LspDiagnosticsUnderlineError = { link = "DiagnosticUnderlineError" },
  LspDiagnosticsUnderlineWarning = { link = "DiagnosticUnderlineWarn" },
  DiagnosticFloatingError = { fg = blue, bold = true },
  ...
  DiagnosticError = { fg = light_grey2, bold = true },
  DiagnosticHint = { fg = light_grey2, bold = true },
  DiagnosticInfo = { fg = blue, bold = true },
  DiagnosticWarn = { fg = light_grey2, bold = true },
  ...
  --Neotree
  NeoTreeGitUntracked = { link = "Directory" },

  -- Treesitter
  ["@markup.link"] = { fg = blue },
  ["@property.json"] = { bold = true },
  ["@text.emphasis"] = { italic = true },
  ["@tag.html"] = { bold = true, italic = true },
  ["@tag.tsx"] = { bold = true },
  ["@function.tsx"] = { bold = true },
